                    ...
                    <ul class="sub-nav collapse" id="master-data" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-nav collapse" id="rekening-belanja" data-bs-parent="#master-data">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('rekkelompok.datarekening') }}">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('rekjenis.rekening') }}">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('rekobject.rekeningObject') }}">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('rincianRekening.dataRincian') }}">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
