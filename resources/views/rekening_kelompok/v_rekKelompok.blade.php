    ...
    <div class="row">
       ...
       <div class="card w-100">
          <div class="card-header d-flex justify-content-between">
             ...
             <a class="btn btn-success" href="{{ route('rekkelompok.addRekening') }}">
                      ...
                      <td>
                        <div class="flex">
                            <div class="d-flex justify-content-evenly">
                                <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="{{ route('rekkelompok.edit', $data->id) }}" role="button">
                                ...
                                <form action="{{ route('rekkelompok.destroy', $data->id) }}" method="POST">
                                    @csrf
                                    @method('delete')
