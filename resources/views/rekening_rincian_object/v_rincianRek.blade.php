    ...
    <div class="row">
       ...
       <div class="card w-100">
          <div class="card-header d-flex justify-content-between">
             ...
             <h4 class="card-title text-center">DATA REKENING-RINCIAN OBJEK</h4> <br>
             <a class="btn btn-success" href="{{ route('rincianRekening.addRincian') }}">
         ...
         @endif    
          ...
          <div class="card-body">
             ...
             <table id="datatable" class="table w-100" data-toggle="data-table">
                ...
                <tbody>
                    @foreach ($dataRincian as $data)
                   <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td>{{ $data->kd_rincianRekening }}</td>
                    <td>{{ $data->nm_rincianRekening }}</td>
                    <td><button type="button" class="btn btn-danger btn-sm" onclick="toggleSubTable({{ $loop->iteration }})">
                        Open Rincian Rekening
