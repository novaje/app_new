    ...
    <div class="row">
       ...
       <div class="card w-100">
          <div class="card-header d-flex justify-content-between">
             ...
             <a class="btn btn-success" href="{{ route('rincian_rekening.add_rincian_rekening') }}">
         ...
         @endif    
          ...
          <div class="card-body">
             ...
             <table id="datatable" class="table w-100" data-toggle="data-table">
                ...
                <tbody>
                    @foreach ($dataRincianObject as $data)
                   <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td>{{ $data->kd_rek_object }}</td>
                    <td>{{ $data->nm_rekning }}</td>
                    <td>
